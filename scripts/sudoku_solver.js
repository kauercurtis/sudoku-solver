/** 
 *  sudoku_solver.js - A sudoku solver
 *  Author: Curtis Kauer 2023 
*/
...
*/
function initializeSudokuToSolve(sudoku){
    ...
    while(currentIndex <= 81 && isSuccessful != false){
        ...
        else if(isContradictionToSudokuRules(currentIndex, sudoku, Number(currentSquare.value))){
...
/*
    solveSudoku - driving function for traversalDirector()
...
function solveSudoku(sudoku){
    let startingIndex = getNextSudokuIndex(0, sudoku);
    
    while(startingIndex <= 81){
        startingIndex = sudokuTraversalDirector(startingIndex, sudoku, sudoku[startingIndex] + 1);
    }
}
...
/*
    isContradictionToSudokuRules - Wrapper function for all individual checkContradiction functions
    ...
    functions that use it - initializeSudoku(), traversalDirector()
*/
function isContradictionToSudokuRules(sudokuIndex, sudoku, value){
...
*/
function getNextSudokuIndex(index, sudoku){
    do{
        ++index;
...
/*
    ...
    arg1 - index - the index of the value in question
    arg2 - sudoku - the array representation of a sudoku
...
/*
    ...
    arg1 - index - the starting index to traverse from (exclusive)
    arg2 - sudoku - the array representation of a sudoku
...
/*
    ...
    arg1 - value - the constant value to convert
...
/*
    ...
    arg1 - index - the current index position in an array representation of a sudoku
...
/*
    ...
    arg1 - index - the current index to plug in numbers to 
    arg2 - sudoku - the array representation of sudoku
    arg3 - value - starting value to try 
...
*/
function sudokuTraversalDirector(index, sudoku, value){
    if(index > 81){
        return index;
    }
    
    while(value < 10){
        if(isContradictionToSudokuRules(index, sudoku, value) === true){
            ++value;
        }
        else{
            sudoku[index] = value;
...
//this conditional makes sure the value at an index returned is not greater than 9
    if(value > 9){
        ...
        return getNextSudokuIndex(index, sudoku);
    }
}
